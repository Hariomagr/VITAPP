...
import com.example.lerningapps.vitapp.adapter_curriculum_uc;
...
public class UC extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    Context ctx;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String fac = test1.getString("uc",null);
        ...
        Type type = new TypeToken<ArrayList<Curriculum_UC>>(){}.getType();
        ArrayList<Curriculum_UC> data = gson.fromJson(fac,type);
        if(data!=null) {
            adapter_curriculum_uc adapter = new adapter_curriculum_uc(getActivity(), R.layout.adapter_curriculum, data);
