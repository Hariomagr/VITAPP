...
import com.example.lerningapps.vitapp.adapter_exam_venue1;
...
public class cat2 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    Context ctx;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String fac = test1.getString("cat2",null);
        Type type = new TypeToken<ArrayList<exam_catII>>(){}.getType();
        ArrayList<exam_catII> data = gson.fromJson(fac,type);
        if(data!=null) {
            adapter_exam_venue1 adapter = new adapter_exam_venue1(getActivity(), R.layout.exam_venue_adapter, data);
