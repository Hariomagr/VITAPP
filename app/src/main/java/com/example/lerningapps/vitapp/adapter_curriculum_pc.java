...
public class adapter_curriculum_pc extends ArrayAdapter<Curriculum_PC> {
    ...
    public adapter_curriculum_pc(Context context, int resource, ArrayList<Curriculum_PC> objects) {
