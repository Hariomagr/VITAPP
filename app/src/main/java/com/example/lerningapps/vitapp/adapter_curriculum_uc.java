...
public class adapter_curriculum_uc extends ArrayAdapter<Curriculum_UC> {
    ...
    public adapter_curriculum_uc(Context context, int resource, ArrayList<Curriculum_UC> objects) {
