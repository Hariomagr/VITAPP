...
public class adapter_curriculum_pe extends ArrayAdapter<Curriculum_PE> {
    ...
    public adapter_curriculum_pe(Context context, int resource, ArrayList<Curriculum_PE> objects) {
