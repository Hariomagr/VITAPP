...
import com.example.lerningapps.vitapp.fragments.friday;
import com.example.lerningapps.vitapp.fragments.monday;
import com.example.lerningapps.vitapp.fragments.saturday;
import com.example.lerningapps.vitapp.fragments.sunday;
import com.example.lerningapps.vitapp.fragments.thursday;
import com.example.lerningapps.vitapp.fragments.tuesday;
import com.example.lerningapps.vitapp.fragments.wednesday;
...
public class schedule extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SharedPreferences pref12 = getActivity().getSharedPreferences("schedule_index", 0);
            ...
            call.enqueue(new Callback<timetable_pojo>() {
                ...
                public void onResponse(Call<timetable_pojo> call, Response<timetable_pojo> response) {
                    if (response.code() == 200) {
                        ...
                        editortest.commit();
                        SharedPreferences pref11 = getActivity().getSharedPreferences("schedule_index", 0);
