...
public class exam_catI
{
    ...
    public exam_catI(String time, String course_code, String session, String exam_date, String week_day, String table_number, String course_name, String venue, String slot, String course_type) {
        this.time = time;
