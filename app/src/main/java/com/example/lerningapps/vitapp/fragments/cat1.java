...
import com.example.lerningapps.vitapp.adapter_exam_venue;
...
public class cat1 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    Context ctx;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String fac = test1.getString("cat1",null);
        Type type = new TypeToken<ArrayList<exam_catI>>(){}.getType();
        ArrayList<exam_catI> data = gson.fromJson(fac,type);
        if(data!=null) {
            adapter_exam_venue adapter = new adapter_exam_venue(getActivity(), R.layout.exam_venue_adapter, data);
