...
import com.example.lerningapps.vitapp.adapter_curriculum_ue;
...
public class UE extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    Context ctx;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String fac = test1.getString("ue",null);
        ...
        Type type = new TypeToken<ArrayList<Curriculum_UE>>(){}.getType();
        ArrayList<Curriculum_UE> data = gson.fromJson(fac,type);
        if(data!=null) {
            adapter_curriculum_ue adapter = new adapter_curriculum_ue(getActivity(), R.layout.adapter_curriculum, data);
