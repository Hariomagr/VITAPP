...
import com.example.lerningapps.vitapp.adapter_curriculum_pe;
...
public class PE extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    Context ctx;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String fac = test1.getString("pe",null);
        ...
        Type type = new TypeToken<ArrayList<Curriculum_PE>>(){}.getType();
        ArrayList<Curriculum_PE> data = gson.fromJson(fac,type);
        if(data!=null) {
            adapter_curriculum_pe adapter = new adapter_curriculum_pe(getActivity(), R.layout.adapter_curriculum, data);
